 ...
 * @author Nishad
 */
public class JobProcessManagerRole extends Role {
    ...
    public JPanel createWorkPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization, Enterprise enterprise, EcoSystem ecoSystem) {
        ...
        return new JobProcessManagerWorkAreaJPanel(userProcessContainer,userAccount,organization,enterprise,ecoSystem);
    }
